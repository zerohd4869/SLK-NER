...
class BertModel(BertPreTrainedModel):
    ...
    Examples::
        ...
        sequence_output = encoder_outputs[0] #[1][11]
...
class BertForTokenClassification(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = BertModel(config)
        self.dropout = nn.Dropout(config.hidden_dropout_prob)
        self.classifier = nn.Linear(50,config.num_labels) #config.hidden_size, config.num_labels)
        self.fc = nn.Linear(config.hidden_size, 50)
    ...
    Examples::
        ...
        sequence_output = outputs[0] #(batch_size, max_len, 768)
