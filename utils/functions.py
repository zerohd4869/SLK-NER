...
def read_instance_with_gaz(input_file, gaz, word_alphabet, gaz_alphabet, number_normalized, max_sent_length):
    ...
    for idx in range(len(in_lines)):
        ...
        if len(line) > 2:
            ...
            if len(words) > 0:
                ...
                instence_texts.append([words, gazs, reverse_gazs])
                instence_Ids.append([word_Ids, gaz_Ids, reverse_gaz_Ids])
            words = []
            word_Ids = []
