...
from model.functions.iniatlize import init_cnn_weight
from model.functions.iniatlize import init_maxtrix_weight
from model.functions.iniatlize import init_vector
from model.functions.utils import random_embedding
...
class Gaz_Embed(torch.nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.type == 0:
            ...
            return self.gaz_embedding(gaz_seq_tensor)
